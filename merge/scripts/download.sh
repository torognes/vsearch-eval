...
# Get Staphylococcus aureus reference genome, strain USA300 TCH1516
...
# Get Rhodobacter sphaeroides reference genome, strain 2.4.1
...
for name in Staphylococcus_aureus; do
